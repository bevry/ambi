...
``` typescript
import pkg from 'https://unpkg.com/ambi@^8.18.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/ambi/^8.18.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/ambi@^8.18.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/ambi@8.18.0'
</script>
```
